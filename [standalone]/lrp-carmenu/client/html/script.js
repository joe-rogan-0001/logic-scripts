...
$(function () {
    ...
    $('.door').on('click', function() {
        ...
        $.post('https://lrp-carmenu/openDoor', JSON.stringify({
                doorIndex: doorIndex
            })
        );
    });
    ...
    $('.seat').on('click', function() {
        ...
        $.post('https://lrp-carmenu/switchSeat', JSON.stringify({
                seatIndex: seatIndex
            })
        );
    });
    ...
    $('.window').on('click', function() {
        ...
        $.post('https://lrp-carmenu/togglewindow', JSON.stringify({
    ...
    $('.engine').on('click', function() {
        if ($(this).parent().hasClass('disabled')) return;
        $.post('https://lrp-carmenu/toggleengine', JSON.stringify({}));
    });
    ...
    document.onkeyup = function (data) {
        if (open) {
            ...
            if ((
                ...
                // Z or Esc
                $.post('https://lrp-carmenu/escape', JSON.stringify({}));
            }
        }
    };
});
