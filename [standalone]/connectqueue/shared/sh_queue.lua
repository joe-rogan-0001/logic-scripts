...
function Queue:AddToQueue(ids, connectTime, name, src, deferrals)
    ...
    for k,v in pairs(GetPlayerIdentifiers(tmp.source))do            
  ...
  TriggerEvent("qb-log:server:CreateLog", "joinleave", "Connecting", "green", "Player: **"..GetPlayerName(tmp.source).."** (**"..tmp.source.."**)\nSteam: **"..steamid.."**".."\nFiveM: **"..fivem.."**\nLicense: **"..license.."**\nDiscord: **"..discord.."**\nIP: **||"..ip.."||**")
