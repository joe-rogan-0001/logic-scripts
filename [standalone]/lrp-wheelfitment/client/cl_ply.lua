...
function SyncWheelFitment()
    ...
    if didPlyAdjustFitments then
        ...
        local vin = QBCore.Functions.GetPlate(veh)
    ...
    QBCore.Functions.TriggerCallback('np-wheelfitment_sv:setIsWheelFitmentInUse', function(data)
    end, false)
end
...
Citizen.CreateThread(function()
    exports["polyzonehelper"]:AddBoxZone("np-wheelfitment:zone1", vector3(135.88, -3030.43, 7.04), 6.4, 4.0, {heading = 0, minZ = 6.04, maxZ = 9.04, data = {id = "wheel_fitment_zone"}})
    
    -- PD Zone bruh
    exports["polyzonehelper"]:AddBoxZone("np-wheelfitment:zone2", vector3(435.41, -975.99, 25.7), 4.0, 8.6, {
    name="2",
    heading=0,
    minZ=24.5,
    maxZ=27.1,
...
AddEventHandler("polyzonehelper:enter", function(zone, data)
    ...
    Citizen.CreateThread(function()
        ...
        QBCore.Functions.TriggerCallback('np-wheelfitment_sv:setIsWheelFitmentInUse', function(result)
...
AddEventHandler('baseevents:enteredVehicle', function()
    ...
    QBCore.Functions.TriggerCallback('np-wheelfitment_sv:checkfitment', function(result)
        if result then
            TriggerEvent('np-wheelfitment_cl:applySavedWheelFitment', result, veh)
        end
    end, plate)
end)
