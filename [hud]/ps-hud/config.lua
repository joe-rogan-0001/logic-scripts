...
Config.StressChance = 0.000001 -- Default: 10% -- Percentage Stress Chance When Shooting (0-1)
...
Config.MinimumSpeedUnbuckled = 500000 -- Going Over This Speed Will Cause Stress
