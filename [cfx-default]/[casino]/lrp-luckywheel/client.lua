...
CreateThread(function()
    local LuckyWheelZone = CircleZone:Create(vector3(990.25, 42.81, 70.50), 2.5, {
        name="LuckyWheelZone",
        heading=328.0,
        debugPoly=false,
        useZ=true,
...
--							{
--								event = "luckywheel:client:startWheelt",
--								icon = "fas fa-sync-alt",
--								label = "Turbo Spin",
--							},
						},
...
RegisterNetEvent("luckywheel:client:startWheel", function()
	--QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		--if HasItem then
			TriggerServerEvent("luckywheel:getwheel", 2000)
		--else
...
RegisterNetEvent("luckywheel:client:startWheelt", function()
	--QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		--if HasItem then
			TriggerServerEvent("luckywheel:getwheel", 2500)
		--else
			--QBCore.Functions.Notify('You are not a V.I.P of the casino', 'error', 3500)
		--end
	--end, "casino_vip")
...
RegisterNetEvent("dojLuckywheel:winCar", function() 
	...
	QBCore.Functions.SpawnVehicle(Config.VehiclePrize, function(veh)
		...
		QBCore.Functions.Notify("YOU WON THE SHOW CAR!", "primary", 3500)
		QBCore.Functions.Notify("Your car has been parked outside the garage round back!", "primary", 7500)
	end, coords, true)            
end)
