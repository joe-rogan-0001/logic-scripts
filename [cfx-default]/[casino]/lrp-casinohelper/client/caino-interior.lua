...
function drawCarForWins()
	...
	spinningCar = CreateVehicle(Config.VehicleOnDisplay,975.5, 40.41, 72.16 + 0.05, 0.0, 0, 0)
	Wait(0)
	SetVehicleDirtLevel(spinningCar, 0.0)
	SetVehicleOnGroundProperly(spinningCar) 
	Wait(0)
	FreezeEntityPosition(spinningCar, 1)
  SetVehicleCustomPrimaryColour(spinningCar, 222, 255, 222  )
  spinningObject = spinningCar
end
