    ...
    while true do
      ...
      if GetHashKey("WEAPON_FLASHLIGHT") == GetSelectedPedWeapon(ped) or triggered then
        ...
        if IsControlJustReleased(0,38) and minScan < 2.0 then
          ...
          QBCore.Functions.Progressbar('pickup_evidence', 'Picking Up Evidence..', 5000, false, true, {
...
function PickUpItem(id,eType,other,item)
  TriggerServerEvent('evidence:server:AddEvidenceToInventory', id,eType,other,item)
