...
local props = {
	...
	["weapon_combatpdw"] = { model = "w_sb_mpx", hash = joaat("weapon_combatpdw"), tier = 1 },
	["weapon_combatpdwpd"] = { model = "w_sb_mpx", hash = joaat("weapon_combatpdwpd"), tier = 1 },
	...
	["weapon_mp5pd"] = { model = "w_sb_mp5", hash = joaat("weapon_mp5pd"), tier = 1 },
	...
	["weapon_pumpshotgun"] = { model = "w_sg_izh81", hash = joaat("weapon_pumpshotgun"), tier = 1 },
	["weapon_pumpshotgun_mk2"] = { model = "w_sg_pumpshotgunmk2", hash = joaat("weapon_pumpshotgun_mk2"), tier = 1 },
	["weapon_pumpshotgun_mk2pd"] = { model = "w_sg_pumpshotgunmk2", hash = joaat("weapon_pumpshotgun_mk2pd"), tier = 1 },
	["weapon_sawnoffshotgun"] = { model = "w_sg_sawnoff", hash = joaat("weapon_sawnoffshotgun"), tier = 1 },
	["weapon_musket"] = { model = "w_ar_musket", hash = joaat("weapon_musket"), tier = 1 },
	["weapon_ltl"] = { model = "w_sg_ltl", hash = joaat("weapon_ltl"), tier = 1 },
	["weapon_combatshotgun"] = { model = "w_sg_pumpshotgunh4", hash = joaat("weapon_combatshotgun"), tier = 1 },
	["weapon_advancedrifle"] = { model = "w_ar_advancedrifle", hash = joaat("weapon_advancedrifle"), tier = 1 },
	["weapon_advancedrifle2"] = { model = "w_ar_advancedrifle2", hash = joaat("weapon_advancedrifle2"), tier = 1 },
	["weapon_assaultrifle2"] = { model = "w_ar_assaultrifle2", hash = joaat("weapon_assaultrifle2"), tier = 1 },
	...
	["weapon_compactrifle"] = { model = "w_ar_draco", hash = joaat("weapon_compactrifle"), tier = 1 },
	["weapon_scarh"] = { model = "w_ar_scar", hash = joaat("weapon_scarh"), tier = 1 },
	["weapon_scarhpd"] = { model = "w_ar_scar", hash = joaat("weapon_scarhpd"), tier = 1 },
	["weapon_m4pd"] = { model = "w_ar_m4", hash = joaat("weapon_m4pd"), tier = 1 },
	...
	["weapon_sniperrifle"] = { model = "w_sr_m24", hash = joaat("weapon_sniperrifle"), tier = 1 },
	["weapon_m14"] = { model = "w_sr_m14", hash = joaat("weapon_m14"), tier = 1 },
	["weapon_sniperrifle2"] = { model = "w_sr_sniperrifle2", hash = joaat("weapon_sniperrifle2"), tier = 1 },
	["weapon_dragunov"] = { model = "w_sr_dragunov", hash = joaat("weapon_dragunov"), tier = 1 },
	...
	["weapon_microsmg2"] = { model = "w_sb_microsmg2", hash = joaat("weapon_microsmg2"), tier = 1 },
	["weapon_microsmg3"] = { model = "w_sb_microsmg3", hash = joaat("weapon_microsmg3"), tier = 1 },
	["weapon_smg_mk2"] = { model = "w_sb_smgmk2", hash = joaat("weapon_smg_mk2"), tier = 1 },
	["weapon_machinepistol"] = { model = "w_sb_compactsmg", hash = joaat("weapon_machinepistol"), tier = 1 },
	["weapon_minismg"] = { model = "w_sb_minismg", hash = joaat("weapon_minismg"), tier = 1 },
	["weapon_dbshotgun"] = { model = "w_sg_doublebarrel", hash = joaat("weapon_dbshotgun"), tier = 1 },
	["weapon_autoshotgun"] = { model = "w_sg_sweeper", hash = joaat("weapon_autoshotgun"), tier = 1 },
	["weapon_sawnoffshotgun"] = { model = "w_sg_sawnoff", hash = joaat("weapon_sawnoffshotgun"), tier = 1 },
	["yakuza_chain"] = { model = "yakuza_chain", hash = joaat("yakuza_chain"), tier = 5 },

	-- tier2
	["weapon_bats"]      = { model = "w_me_baseball_bat_barbed", hash = joaat("weapon_bats"), tier = 2 },
	["weapon_katanas"]    = { model = "katana_sheath", hash = joaat("weapon_katanas"), tier = 2, zr = -90.0, yr = 180.0, xr = -40.0,
		y = -0.14, x = 0.1, z = -0.015 },
	...
	["microwave"]      = { carry = true, model = "prop_microwave_1", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 91.0,
		...
		["package"]                     = { carry = true,   model = "hei_prop_hei_drug_pack_01b",    bone = 28422, x = 0.01,  y = -0.02, z = -0.12, xr = 0.0, yr = 0.0,   zr = 0.0,    blockAttack = true, blockCar = true, blockRun = true},
		["weedpackage"]                     = { carry = true,   model = "hei_prop_hei_drug_pack_01b",    bone = 28422, x = 0.01,  y = -0.02, z = -0.12, xr = 0.0, yr = 0.0,   zr = 0.0,    blockAttack = true, blockCar = true, blockRun = true},
}
