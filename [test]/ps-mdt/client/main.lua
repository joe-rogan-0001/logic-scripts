...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    TriggerServerEvent("ps-mdt:server:OnPlayerLoaded")
...
-- Uses the lrp-core bill command to send a fine to a player
