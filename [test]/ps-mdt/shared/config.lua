...
Config.LogPerms = {
	['police'] = {
        --police
        [7] = true, --First Lieutenant
        [8] = true, --Captain
        [9] = true, --Commander
        [10] = true, --Chief

        --Rangers
        [15] = true, --Ranger Sergeant
        [16] = true, --Ranger Lieutenant

        --Sheriff
        [22] = true, --Captain
        [23] = true, --Deputy Sheriff
        [24] = true, --Sheriff
	}
}
...
Config.RemoveIncidentPerms = {
	['police'] = {
        ...
        [3] = true,
        [4] = true, --Sergeant
		[5] = true, --Sergeant first class
        [6] = true, --Second Lieutenant
        [7] = true, --First Lieutenant
        [8] = true, --Captain
        [9] = true, --Commander
        [10] = true, --Chief
