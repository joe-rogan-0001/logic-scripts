...
CreateThread(function()
  exports['lrp-target']:AddBoxZone("1234", vector3(447.09, -1000.7, 30.74), 1.5, 1.6, {
    name = "1234", 
    heading = 3, 
    debugPoly = false, 
    minZ = 29, 
...
RegisterNetEvent('qb-k9:client:menu', function()
  ...
  exports['lrp-menu']:openMenu(K9Purchase)
end)
...
exports['lrp-menu']:openMenu(K9Dawgs)
end)
...
RegisterCommand("caninecommanders", function()
  if activate_k9 then
    ...
    exports['lrp-menu']:openMenu(k9Commands)
  end
end, false) 
