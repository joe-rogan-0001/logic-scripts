...
CreateThread(function()
    exports['lrp-target']:AddTargetModel(Config.BossPed, {
        options = {
            { 
				type = "client",
...
AddEventHandler("sd-oxyrun:createOxyVehicle", function(route)
	...
	exports['lrp-target']:AddTargetEntity(oxyVeh, {
		options = {
			{
				type = "client",
...
AddEventHandler("sd-oxyrun:client:deliverPackage", function()
	if holdingBox then
		exports['lrp-target']:RemoveTargetEntity(oxyVeh, Lang:t("target.handoff_package"))
		holdingBox = false
...
CreateThread(function()
	exports['lrp-target']:AddTargetModel(Config.SupplierPeds, {
		options = {
			{
				type = "client",
...
RegisterNetEvent('sd-oxyrun:client:sendToOxy', function()
	...
	if trueCount == totalCount then
		...
		exports['lrp-target']:RemoveTargetModel(Config.BossPed, {
