if Config.DumpsterDiving.Enable then if Config.Debug then print("^5Debug^7: ^2Loading^7: '^6Dumpster Diving^7'") end
    ...
    --Dumpster Third Eye
    exports['lrp-target']:AddTargetModel(Config.DumpsterDiving.models,
        { options = {
    ...
    RegisterNetEvent('jim-recycle:Dumpsters:Search', function(data) local Ped = PlayerPedId()
        ...
        if not searched then -- If hasn't been searched yet
            ...
            if Config.DumpsterDiving.skillcheck == "lrp-skill" then
                local Skillbar = exports['SN-Hacking']:SkillBar({5000, 6000}, 9, 3)
            ...
            elseif Config.DumpsterDiving.skillcheck == "lrp-skillbar" then
