...
CreateThread(function()
    ...
    exports['lrp-target']:AddTargetEntity(bmxPed, {
        options = {
            {
                type = "client",
...
createCheckpoint = function(checkpoint)
    ...
    currentZone:onPlayerInOut(function(isPointInside, point)
        if isPointInside then
            ...
            exports['textUi']:Show("Prison Task", 'Progress: ' .. math.floor((currentCheckpoint - 1) * 100 / #obstacles) .. '%')
...
RegisterNetEvent('qb-jail:client:ChinUp', function(data)
    ...
    local progress = 0
    exports['textUi']:Show("Prison Task", 'Progress: ' .. progress .. '%')
    ...
    progress += 15.4
    exports['textUi']:Show("Prison Task", 'Progress: ' .. progress .. '%')
    exports['textUi']:Show("Prison Task", 'Progress: ' .. progress .. '%', 'left')
...
CreateThread(function()
    ...
    exports['lrp-target']:AddTargetModel(mats, {
        options = {
            {
    ...
    exports['lrp-target']:AddTargetModel(benches, {
        options = {
            {
                action = function(entity)
                    BenchPress(entity)
    ...
    exports['lrp-target']:AddTargetModel(`prop_weight_rack_02`, {
        options = {
            {
                action = function(entity)
                    Dumbbells(entity)
    ...
    exports['lrp-target']:AddBoxZone("prison_workout_chinup1", vector3(1643.27, 2527.85, 45.56), 1.4, 0.4, {
    ...
    exports['lrp-target']:AddBoxZone("prison_workout_chinup2", vector3(1649.05, 2529.64, 45.56), 1.4, 0.4, {
...
CreateThread(function()
    exports['lrp-target']:AddBoxZone("prison_kitchen_clean", vector3(1778.68, 2565.07, 45.67), 1.5, 0.8, {
    ...
    exports['lrp-target']:AddBoxZone("prison_kitchen_shelves", vector3(1787.01, 2564.73, 45.67), 2.4, 0.4, {
    ...
    exports['lrp-target']:AddBoxZone("prison_kitchen_counter", vector3(1776.83, 2563.69, 45.67), 2.0, 0.8, {
    ...
    exports['lrp-target']:AddBoxZone("prison_kitchen_stove", vector3(1780.84, 2565.03, 45.67), 1.4, 0.8, {
    ...
    exports['lrp-target']:AddTargetModel(`sanhje_Prison_Cafeteria_table`, {
        options = {
            {
                type = 'client',
...
RegisterNetEvent('qb-jail:client:CompletedCleaningTask', function(result)
    exports['textUi']:Show("Prison Task", "Task Completed! Good Job!")
    for i=1, #result do
        createJobTaskBlip(result[i], 'Cleaning Cells', 456, false)
    end
    Wait(4000)
    exports['textUi']:Show("Prison Task", 'Current Task: Cleaning Cells - Progress: 0%')
end)
...
CreateThread(function()
    ...
    exports['lrp-target']:AddTargetModel(objects, {
        options = {
            {
                action = function(entity)
                    CleanUp(entity)
...
CreateThread(function()
    exports['lrp-target']:AddBoxZone("prison_scrap_1", vector3(1658.67, 2519.24, 44.56), 7.0, 7.0, {
        name = "prison_scrap_1",
        heading = 90,
        debugPoly = false,
        minZ = 44.50,
    ...
    exports['lrp-target']:AddBoxZone("prison_scrap_2", vector3(1649.94, 2511.99, 44.56), 3.0, 3.0, {
        name = "prison_scrap_2",
        heading = 90,
        debugPoly = false,
        minZ = 44.50,
...
RegisterNetEvent('qb-jail:client:CompleteElectrical', function(index)
    ...
    exports['textUi']:Show("Prison Task", 'Current Task: Electrical - Progress: ' .. math.floor(100 * (#Config.Electrical - amount) / #Config.Electrical) .. '%')
end)
...
RegisterNetEvent('qb-jail:client:ResetElectrical', function()
    ...
    exports['textUi']:Show("Prison Task", 'Task Completed, Well Done!')
    Wait(4000)
    exports['textUi']:Show("Prison Task", 'Current Task: Electrical - Progress: 0%')
end)

CreateThread(function()
    for k, v in pairs(Config.Electrical) do
        exports['lrp-target']:AddBoxZone("prison_electrical_" .. k, v.coords.xyz, 0.5, 1.0, {
...
CreateThread(function()
    ...
    exports['lrp-target']:AddTargetEntity(farmingPed, {
        options = {
            {
                type = "client",
    ...
    exports['lrp-target']:AddBoxZone("prison_farming_1", vector3(1689.88, 2545.67, 44.56), 3.5, 3.5, {
    ...
    exports['lrp-target']:AddBoxZone("prison_farming_2", vector3(1695.45, 2553.88, 44.56), 3.5, 3.5, {
    ...
    exports['lrp-target']:AddBoxZone("prison_farming_3", vector3(1695.21, 2548.71, 44.56), 3.5, 3.5, {
