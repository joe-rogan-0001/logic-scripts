...
local AlertCops = function()
    exports['pb_dispatch']:PrisonBreak() -- pb_dispatch alert
...
local ThermiteEffect = function(index)
    ...
    TriggerServerEvent('ox_doorlock:setState', Config.JailBreak.Thermite[index][3], false)
end
    ...
    QBCore.Functions.TriggerCallback('qb-powerplant:server:getCops', function(cops)
        if data.index == 1 and cops < Config.JailBreakCops then
            ...
            if QBCore.Functions.HasItem('thermite') then
                ...
                exports['pb_minigames']:Thermite(function(success)
                    if success then
...
RegisterNetEvent('qb-jail:client:OutsideHack', function()
    ...
    exports['pb_minigames']:VarHack(function(success)
        ...
        if success then
            ...
            TriggerServerEvent('ox_doorlock:setState', 'jail-gate2', false)
            AlertCops()
...
RegisterNetEvent('qb-jail:client:UnlockCellDoors', function()
    ...
    local dialog = exports['pb_ui']:ShowInput({
    ...
    TriggerServerEvent('ox_doorlock:setState', 'cell_door_' .. dialog.cell, false)
end)

CreateThread(function()
    exports['lrp-target']:AddBoxZone('jailbreak_outsidethermite_1', vector3(1846.61, 2571.43, 45.67), 1.4, 0.5, {
    ...
    exports['lrp-target']:AddBoxZone('jailbreak_outsidethermite_2', vector3(1791.74, 2612.13, 45.57), 0.5, 0.4, {
    ...
    exports['lrp-target']:AddBoxZone('jailbreak_outsidethermite_3', vector3(1761.29, 2517.19, 45.57), 1.0, 0.5, {
    ...
    exports['lrp-target']:AddBoxZone('jailbreak_outsidehack_1', vector3(1831.31, 2603.95, 45.89), 0.6, 0.4, {
    ...
    exports['lrp-target']:AddBoxZone('jailbreak_cell_panel', vector3(1775.0, 2492.35, 49.67), 2.2, 0.4, {
