...
------------------------------------------------------------
	...
	SellingPrices = { -- Selling Prices
		...
		['emerald_necklace'] = 550,
		['ruby_necklace'] = 550,
		['sapphire_necklace'] = 550,
		['diamond_necklace_silver'] = 550,
		['emerald_necklace_silver'] = 550,
		...
		['diamond_earring_silver'] = 475,
		['emerald_earring_silver'] = 475,
		['ruby_earring_silver'] = 475,
...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "goldpan", price = 3500, amount = 100, info = {}, type = "item", slot = 5, },
			{ name = "pickaxe",	price = 500, amount = 100, info = {}, type = "item", slot = 6, },
			{ name = "miningdrill",	price = 10500, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "mininglaser",	price = 40000, amount = 5, info = {}, type = "item", slot = 8, },
