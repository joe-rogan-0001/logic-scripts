...
local function InjuriedPerson()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = {"EMS", "ambulance", "LEO", "police"} -- type or jobs that will get the alerts
    })
end
...
RegisterNetEvent("ps-dispatch:client:storeRobbery", function ()
    StoreRobbery()
end)
...
--TriggerClientEvent("ps-dispatch:client:BobcatRobbery")
...
RegisterNetEvent("ps-dispatch:client:BobcatRobbery", function ()
    BobcatRobbery()
end)
...
RegisterNetEvent("ps-dispatch:client:HouseRobbery", function ()
    HouseRobbery()
end)
...
local function OfficerDown()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = {"police", "ambulance"} -- type or jobs that will get the alerts
    })
end
...
RegisterNetEvent("ps-dispatch:client:suspiciousActivity", function ()
    SuspiciousActivity()
end)
