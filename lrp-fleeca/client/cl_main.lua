...
AddEventHandler('cr-fleeca:darkmail', function()
    ...
    TriggerServerEvent('qb-phone:server:sendNewMail', {
        sender = "Lester",
        subject = "#A-1001",
        message = "<br><br> Good job, </b><br><br> You bypassed the captcha. Give me a few minutes to open the door!",
    })
end)
