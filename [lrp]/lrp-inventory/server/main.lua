	...
	elseif QBCore.Shared.SplitStr(fromInventory, "-")[1] == "itemshop" then
		...
		elseif QBCore.Shared.SplitStr(shopType, "_")[1] == "Itemshop" then
			if Player.Functions.RemoveMoney("cash", price, "itemshop-bought-item") then
				...
				if itemData.name == 'casino_goldchip' then 
					TriggerEvent('qb-banking:society:server:DepositMoney', src, price, 'casino')
				end
				if itemData.name == 'casino_blackchip' then 
					TriggerEvent('qb-banking:society:server:DepositMoney', src, price, 'casino')
				end
				if itemData.name == 'casino_bluechip' then 
					TriggerEvent('qb-banking:society:server:DepositMoney', src, price, 'casino')
				end
				if itemData.name == 'casino_redchip' then 
					TriggerEvent('qb-banking:society:server:DepositMoney', src, price, 'casino')
				end
				if itemData.name == 'casino_whitechip' then 
					TriggerEvent('qb-banking:society:server:DepositMoney', src, price, 'casino')
				end
				Player.Functions.AddItem(itemData.name, fromAmount, toSlot, itemData.info)
