...
function showBlur() {
    $.post('https://lrp-inventory/showBlur');
}
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://lrp-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://lrp-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://lrp-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://lrp-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://lrp-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://lrp-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://lrp-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://lrp-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://lrp-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://lrp-inventory/CloseInventory", JSON.stringify({}));
