cars = [
    { model: "gtrc", label: "AMG GT Black Series", price: 1150000, onStock: 1, category: 0 },
    { model: "gt63", label: "AMG GT63", price: 635000, onStock: 1, category: 0 },
    { model: "r32", label: "Skyline R32", price: 690000, onStock: 1, category: 0 },
    { model: "fnf4r34", label: "Skyline R34", price: 710000, onStock: 1, category: 0 },
    { model: "z2879", label: "Camaro Z28 1979", price: 565000, onStock: 1, category: 0 },
    { model: "exor", label: "Camaro ZL1", price: 780000, onStock: 1, category: 0 },
    { model: "fk8", label: "Civic Type-R", price: 515000, onStock: 1, category: 0 },
    { model: "delsoleg", label: "Civic Type-R EG", price: 430000, onStock: 1, category: 0 },
    { model: "gt86", label: "GT86", price: 630000, onStock: 1, category: 0 },
    { model: "contss18", label: "Continental SS", price: 809000, onStock: 1, category: 0 },
    { model: "c7", label: "Corvette C7", price: 845000, onStock: 1, category: 0 },
    { model: "esv", label: "Escalade", price: 560000, onStock: 1, category: 0 },
    { model: "srt8b", label: "Grand Cherokee SRT-8", price: 540000, onStock: 1, category: 0 },
    { model: "bluecunt", label: "HSV", price: 485000, onStock: 1, category: 0 },
    { model: "db11", label: " DB11", price: 1185000, onStock: 1, category: 0 },
    { model: "m3e36", label: "M3 E46", price: 540000, onStock: 1, category: 0 },
    { model: "m5e60", label: "M5 E60", price: 640000, onStock: 1, category: 0 },
    { model: "na6", label: "MX5 NA", price: 430000, onStock: 1, category: 0 },
    { model: "lc100", label: "Land Cruiser", price: 445000, onStock: 1, category: 0 },
    { model: "lp670", label: "Murcielago LP670", price: 1080000, onStock: 1, category: 0 },
    { model: "66fastback", label: "Mustang 1965", price: 550000, onStock: 1, category: 0 },
    { model: "rmodmustang", label: "Mustang 2015", price: 480000, onStock: 1, category: 0 },
    { model: "mustang19", label: "Mustang GT 2015", price: 490000, onStock: 1, category: 0 },
    { model: "panamera17turbo", label: "Panamera Turbo", price: 645000, onStock: 1, category: 0 },
    { model: "r1", label: "R1", price: 415000, onStock: 1, category: 0 },
    { model: "r8v10", label: "R8 V1", price: 735000, onStock: 1, category: 0 },
    { model: "r8h", label: "R8 Hycade", price: 1135000, onStock: 1, category: 0 },
    { model: "audirs6tk", label: "RS6", price: 685000, onStock: 1, category: 0 },
    { model: "fnfrx7", label: "RX7", price: 935000, onStock: 1, category: 0 },
    { model: "f150", label: "Raptor F150", price: 445000, onStock: 1, category: 0 },
    { model: "ap2", label: "S2000", price: 720069, onStock: 1, category: 0 },
    { model: "subwrx", label: "WRX", price: 575000, onStock: 1, category: 0 },
    { model: "cord812", label: "Cord 812", price: 375000, onStock: 1, category: 0 },
    ...
    { model: "dloader", label: "Duneloader", price: 79000, onStock: 1, category: 4 },
    ...
    { model: "cavalcade", label: "Cavalcade", price: 65000, onStock: 1, category: 6 },
    ...
    { model: "emperor2", label: "Emperor", price: 23000, onStock: 1, category: 7 },
    ...
    { model: "moonbeam", label: "Moonbeam Custom", price: 60000, onStock: 1, category: 11 },
    ...
    { model: "pony", label: "Pony", price: 60000, onStock: 1, category: 11 },
    { model: "pony2", label: "Pony", price: 12000, onStock: 1, category: 11 },
    { model: "newsvan", label: "Rumpo News", price: 23000, onStock: 1, category: 11 },
    { model: "speedo", label: "Speedo", price: 30000, onStock: 1, category: 11 },
    { model: "surfer", label: "Surfer", price: 35000, onStock: 1, category: 11 },
    { model: "surfer2", label: "Surfer Kona", price: 34000, onStock: 1, category: 11 },
