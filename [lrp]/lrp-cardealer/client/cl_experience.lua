...
RegisterNUICallback("lrp-ui:application-closed", function(data, cb)
...
AddEventHandler("lrp-cardealer:exit", function()
  Citizen.CreateThread(function()
    showroomOpen = false
    DoScreenFadeOut(0)
    Wait(400)
...
local function calculateStats()
  ...
  local brand = GetMakeNameFromVehicleModel(model) or 'IMPORT'
...
RegisterNUICallback("lrp-ui:showroomChangeCar", function(data, cb)
...
AddEventHandler("lrp-cardealer:enterExperience", function()
  openShowroom("pdm")
...
RegisterCommand("showroom", function()
  TriggerEvent("lrp-cardealer:enterExperience")
end)
]]--