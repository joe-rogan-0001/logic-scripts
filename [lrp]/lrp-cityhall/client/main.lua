...
RegisterNetEvent('qb-cityhall:client:openmenu')
AddEventHandler('qb-cityhall:client:openmenu', function()
    qbCityhall.Open()
end)
    ...
    for type,_ in pairs(licensesMeta) do
        if licensesMeta[type] then
            ...
            elseif type == "pilot" then
                ...
                label = "Pilot License"
            elseif type == "boating" then
                licenseType = "boating_license"
                label = "Boating License"
            end
