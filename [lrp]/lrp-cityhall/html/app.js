...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $.post('https://lrp-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    ...
    $.post('https://lrp-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post('https://lrp-cityhall/applyJob', JSON.stringify({
        job: selectedJobId
    }))
