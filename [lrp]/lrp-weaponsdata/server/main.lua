...
RegisterNetEvent("weapons:server:SetWeaponQuality", function(data, repamo, hp)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local WeaponSlot = Player.PlayerData.items[data.slot]

    if WeaponSlot.info.repamo == null then
        WeaponSlot.info.repamo = repamo
    elseif WeaponSlot.info.repamo == "1" then
        WeaponSlot.info.repamo = repamo
    elseif WeaponSlot.info.repamo == "2" then
        WeaponSlot.info.repamo = repamo
    end
    WeaponSlot.info.quality = hp

    Player.Functions.SetInventory(Player.PlayerData.items, true)
    TriggerClientEvent('QBCore:Notify', src, "Your weapon has been repaired", "success")
end)

RegisterNetEvent("weapons:server:scratchweaponserial", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local WeaponSlot = Player.PlayerData.items[data.slot]

    WeaponSlot.info.serie = "Serial Scratched"

    Player.Functions.SetInventory(Player.PlayerData.items, true)
    TriggerClientEvent('QBCore:Notify', src, "Your weapons serial has been scratched", "success")
end)
...
QBCore.Functions.CreateUseableItem('tazer_cartilage', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_TAZER', 3, item)
end)

QBCore.Functions.CreateUseableItem('emp_cartilage', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_RAILGUN', 1, item)
end)

QBCore.Functions.CreateUseableItem('rubberslug', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_LTL', 1, item)
end)
...
-- glock
QBCore.Functions.CreateUseableItem('glock_defaultclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'defaultclip')
end)

QBCore.Functions.CreateUseableItem('glock_extendedclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'extendedclip')
end)

QBCore.Functions.CreateUseableItem('glock_flashlight', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'flashlight')
end)


-- dp9
QBCore.Functions.CreateUseableItem('dp9_defaultclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'defaultclip')
end)

QBCore.Functions.CreateUseableItem('dp9_extendedclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'extendedclip')
end)


-- m4
QBCore.Functions.CreateUseableItem('m4_defaultclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'defaultclip')
end)

QBCore.Functions.CreateUseableItem('m4_muzzle', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'muzzle')
end)

QBCore.Functions.CreateUseableItem('m4_flashlight', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'flashlight')
end)

QBCore.Functions.CreateUseableItem('m4_ironsight', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'scope')
end)

QBCore.Functions.CreateUseableItem('m4_holographic', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'scope')
end)

QBCore.Functions.CreateUseableItem('m4_grip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'grip')
end)
