...
Config.DurabilityMultiplier = {
	...
	['weapon_glockpd'] 			= 0.15,
    ['weapon_scarhpd'] 			= 0.15,
	['weapon_combatpdwpd']  	= 0.15,
	['weapon_mp5pd'] 			= 0.15,
    ['weapon_m14pd'] 			= 0.15,
	['weapon_ltl'] 	            = 0.15,
	['weapon_pumpshotgun_mk2pd'] 	    = 0.15,
...
WeaponAttachments = {
    ...
    ['WEAPON_GLOCK'] = {
        ['defaultclip'] = {
            ...
            label = 'Default Clip',
            item = 'glock_defaultclip',
            type = 'clip',
        },
        ['extendedclip'] = {
            component = 'COMPONENT_GLOCK_CLIP_02',
            label = 'Extended Clip',
            item = 'glock_extendedclip',
            type = 'clip',
        },
        ['flashlight'] = {
            component = 'COMPONENT_AT_GLOCK_FLSH',
            label = 'Flashlight',
            item = 'glock_flashlight',
        },
    },
    ...
    ['WEAPON_DP9'] = {
        ['defaultclip'] = {
            component = 'COMPONENT_DP9_CLIP_01',
            label = 'Default Clip',
            item = 'dp9_defaultclip',
            type = 'clip',
        },
        ['extendedclip'] = {
            component = 'COMPONENT_DP9_CLIP_02',
            label = 'Extended Clip',
            item = 'dp9_extendedclip',
            type = 'clip',
        },
    },
    ...
    ['WEAPON_M4'] = {
        ...
        ['scope'] = {
            component = 'COMPONENT_AT_SCOPE_SMALL_M4',
            label = 'Iron Sight',
            item = 'm4_ironsight',
        },
        ['scope'] = {
            component = 'COMPONENT_AT_SCOPE_M4',
            label = 'Holographic Sight',
            item = 'm4_holographic',
        },
        ['muzzle'] = {
            component = 'COMPONENT_AT_MUZZLE_M4',
            label = 'muzzle',
            item = 'm4_muzzle',
        },
        ['grip'] = {
            component = 'COMPONENT_AT_M4_AFGRIP',
            label = 'Grip',
            item = 'm4_grip',
        },                              
    },
