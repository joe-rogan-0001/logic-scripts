...
Config.webhook = "https://discord.com/api/webhooks/935628616392380466/nXVjOVvKQfPJ4Q718RhzSfq5LhWZd4xn0Iy-j-tHL-9Ecw24i16epYBYJDQEHHO9_eov"					-- Webhook to send logs to discord
...
Config.contratos = {
	...
	['cargas'] = {
		...
		{ carga = "tanker", nome = "Potassium hydroxide", def = {6,0,0}},
		{ carga = "tanker", nome = "Nitrogen", def = {2,0,1}},
		{ carga = "tanker", nome = "Potassium chloride", def = {5,0,0}},
		{ carga = "tanker", nome = "Poison", def = {5,0,0}},
		{ carga = "tanker", nome = "Pesticide", def = {5,0,0}},
		...
		{ carga = "trailers", nome = "Naval articles trailer", def = {0,0,0}},
		{ carga = "trailers", nome = "Boat trailer", def = {0,1,1}},
		...
		{ carga = "trailers", nome = "Transport of fireworks", def = {1,1,0}},
		{ carga = "trailers", nome = "Transport of explosives", def = {1,1,0}},
		{ carga = "trailers", nome = "Dynamite transport", def = {1,1,0}},
		{ carga = "trailers", nome = "White phosphorus transport", def = {4,1,0}},

		{ carga = "heli1", nome = "Helicopter Transport", def = {0,1,1}},
		{ carga = "ArmyTrailer2", nome = "Army vehicle transport", def = {0,1,1}},
	}
}
...
Config.motoristas = {
	...
	['preco_por_km_min'] = 300,					-- Minimum starting price per KM of the driver (at the end of each delivery)
	['preco_por_km_max'] = 600,					-- Maximum initial price per KM of the driver (at the end of each delivery)
	['preco_min'] = 300,						-- Minimum initial price of the driver (at the end of each delivery)
