local QBCore = exports['lrp-core']:GetCoreObject() -- Grabs our core object
...
AddEventHandler("qb-shiftlog:jobchanged", function(old, new, method,src)
    ...
    if new.name == "police" or new.name == "ambulance" then
...
--DiscordLog("[Shift Logs]", "Shift logger started!", 3447003, "police")