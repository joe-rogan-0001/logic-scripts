...
AddEventHandler('qb-banking:server:Withdraw', function(account, amount, note, fSteamID)
    ...
    if account == "personal" then
        ...
        AddTransaction(src, "personal", -amount, "withdraw", "N/A", (note ~= "" and note or "Transaction $"..format_int(amount).."."))
        TriggerEvent('qb-log:server:CreateLog', 'pdbanking', 'Withdraw', 'green', "Name: ".. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .."\nAmount: $".. amount .. "\nNote: " .. note)
    ...
    if(account == "business") then
        ...
        if data then
            ...
            if sM >= amount then
                ...
                TriggerEvent('qb-log:server:CreateLog', 'pdbanking', 'Withdraw ' .. job.label .. " (Business Withdrawl)", 'green', "Name: ".. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .. "\nAmount: $".. amount .. "\nNote: " .. note)
