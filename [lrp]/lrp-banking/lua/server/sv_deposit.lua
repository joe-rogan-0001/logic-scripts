...
AddEventHandler('qb-banking:server:Deposit', function(account, amount, note, fSteamID)
    ...
    if account == "personal"  then
        ...
        TriggerEvent('qb-log:server:CreateLog', 'pdbankingdeposit', 'Deposit', 'green', "Name: ".. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .."\nAmount: $".. amt .. "\nNote: " .. note)

        AddTransaction(src, "personal", amt, "deposit", "N/A", (note ~= "" and note or "Deposited $"..format_int(amt).." cash."))
        return
    end
    ...
    if account == "business"  then
        ...
        if data then
            ...
            TriggerEvent('qb-log:server:CreateLog', 'pdbankingdeposit', 'Deposit ' .. job.label .. " (Business Deposit)", 'green', "Name: ".. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .. "\nAmount: $".. deposit .. "\nNote: " .. note)
