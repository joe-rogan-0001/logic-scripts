...
RegisterNetEvent('qb-weathersync:server:powerplantblackout', function(status)
    blackout = status
    TriggerEvent('qb-weathersync:server:RequestStateSyncPower', status)
end)

RegisterNetEvent('qb-weathersync:server:RequestStateSyncPower', function(status)
    TriggerClientEvent('qb-weathersync:client:SyncWeather', -1, CurrentWeather, status)
    TriggerClientEvent('qb-weathersync:client:SyncTime', -1, baseTime, timeOffset, freezeTime)
end)
