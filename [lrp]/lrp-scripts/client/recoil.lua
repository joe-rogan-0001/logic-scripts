local recoils = {
	...
	[`weapon_stungunpd`] = 0.0,
	[`weapon_glockpd`] = 0.2,
	[`weapon_scarhpd`] = 0.1,
	[`weapon_combatpdwpd`] = 0.2,
	[`weapon_mp5pd`] = 0.1,
	[`weapon_m14pd`] = 0.7,
	[`weapon_ltl`] = 0.5,
	[`weapon_pumpshotgun_mk2pd`] = 0.5,

	[`weapon_assaultrifle2`] = 0.6,
	[`weapon_m4`] = 0.5,
	[`weapon_m4semi`] = 0.5,
	[`weapon_glock`] = 0.2,
	[`weapon_glock18c`] = 0.8,
	...
	[`weapon_microsmg2`] = 0.4,
	[`weapon_microsmg3`] = 0.4,
	[`weapon_mp5`] = 0.2,
	[`weapon_pumpshotgun_mk2`] = 0.5,
	[`weapon_sniperrifle2`] = 0.11,
	[`weapon_dragunov`] = 0.7,
}
