...
function processVehicleHandling(pCurrentVehicle)
	...
	--if vehicleIdentifier then
	  vehicleIdentifier = GetVehiclePedIsIn(PlayerPedId(), false)
	  ...
	  if IsThisModelABike(GetEntityModel(pCurrentVehicle)) then
		  setVehicleHandling(vehicleIdentifier, pCurrentVehicle, 'fTractionCurveMin', 0.68)
		  setVehicleHandling(vehicleIdentifier, pCurrentVehicle, 'fTractionCurveMax', 0.68)
		  setVehicleHandling(vehicleIdentifier, pCurrentVehicle, 'fInitialDriveForce', 2.0)
		  setVehicleHandling(vehicleIdentifier, pCurrentVehicle, 'fBrakeForce', 2.0)
		...
		--  SetVehicleHandlingFloat(pCurrentVehicle, 'CHandlingData', 'fSuspensionForce', 22.000000)
		  SetVehicleHandlingFloat(pCurrentVehicle, 'CHandlingData', 'fCollisionDamageMult', 1.100000)
