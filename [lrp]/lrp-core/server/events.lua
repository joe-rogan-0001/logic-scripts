...
AddEventHandler('playerDropped', function(reason)
    ...
    if QBCore.Players[src] then
        ...
        TriggerEvent('qb-log:server:CreateLog', 'joinleave', 'Dropped', 'red', "Player: **"..GetPlayerName(src).."** (**"..src.."**)\nReason: **"..reason.."**\nSteam: **"..steamid.."**".."\nFiveM: **"..fivem.."**\nLicense: **"..license.."**\nDiscord: **"..discord.."**\nIP: **||"..ip.."||**")
...
RegisterNetEvent('QBCore:ToggleDuty', function()
    ...
    if Player.PlayerData.job.onduty then
        if Jobname == "police" or Jobname == "police" then
            TriggerEvent('iconic-eblips:server:removePlayerBlipGroup', src, Jobname)
        end
        Player.Functions.SetJobDuty(false)
        TriggerClientEvent('QBCore:Notify', src, Lang:t('info.off_duty'))
    else
        if Jobname == "police" or Jobname == "police" then
            TriggerEvent('iconic-eblips:server:registerPlayerBlipGroup', src, Jobname)
        end
