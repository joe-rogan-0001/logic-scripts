...
RegisterNetEvent('police:client:sendnine', function(desc)
    TriggerEvent('un-dispatch:ninecall', desc)
end)
...
RegisterNetEvent('police:client:runplate')
AddEventHandler('police:client:runplate', function()
local vehicle = QBCore.Functions.GetClosestVehicle()
local plate = GetVehicleNumberPlateText(vehicle, true)

QBCore.Functions.Progressbar("platecheck", "Requesting Plate Check", 5000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
    disableMouse = false,
    disableCombat = false,
}, {}, {}, {}, function()
    TriggerServerEvent('police:server:runplate', plate)
end)
end)

RegisterNetEvent('police:client:riflerack')
AddEventHandler('police:client:riflerack', function()
    local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
    local plate = GetVehicleNumberPlateText(vehicle, true)
    QBCore.Functions.Progressbar("open-rifle-rack", "Unlocking Locked Compartment...", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerServerEvent("inventory:server:OpenInventory", "stash", 'Riflerack_'..plate, {maxweight = 75000, slots = 6})
        TriggerEvent("inventory:client:SetCurrentStash", 'Riflerack_'..plate)
    end, function()
