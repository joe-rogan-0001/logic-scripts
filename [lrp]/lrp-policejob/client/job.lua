...
function MenuImpound(currentSelection)
    ...
    QBCore.Functions.TriggerCallback("police:GetImpoundedVehicles", function(result)
        ...
        if shouldContinue then
            ...
            exports['lrp-menu']:openMenu(impoundMenu)
        end
    end)
...
RegisterNetEvent('police:client:ImpoundVehicle', function(fullImpound, price)
    ...
    if vehicle ~= 0 and vehicle then
        ...
        if #(pos - vehpos) < 5.0 and not IsPedInAnyVehicle(ped) then
            ...
            TriggerServerEvent("qb-garage:server:updateVehicleJobState2", 1, plate)
...
RegisterNetEvent('police:client:EvidenceStashDrawer')
AddEventHandler('police:client:EvidenceStashDrawer', function(casenumber)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "Case Number: "..casenumber, {
        maxweight = 1000000000,
        slots = 500,
    })
    TriggerEvent("inventory:client:SetCurrentStash", "Case Number: "..casenumber)
end)
...
-- Armory
RegisterNetEvent('police:client:armourything')
AddEventHandler('police:client:armourything', function()
