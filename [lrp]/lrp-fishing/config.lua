...
Config.Skillbar = "lrp-skill"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]
Config.targetExport = "lrp-target"                               -- The name of the Target export you are using ["qb-target", "qtarget", "bt-target"]
...
-- Regular Fish
Config.mackerelPrice     = math.random(22,45)                                     -- Price of Mackerel
Config.codfishPrice      = math.random(40,50)                                    -- Price of Cod
Config.bassPrice         = math.random(80,94)                                    -- Price of Normal Fish
Config.flounderPrice     = math.random(80,94)                                    -- Price of Flounder
Config.stingrayPrice     = math.random(80,140)                                    -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = math.random(360,440)                                 -- Price of Dolphins
Config.sharktigerPrice   = math.random(580,620)                                  -- Price of Tigersharks
Config.sharkhammerPrice  = math.random(560,620)                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = math.random(960,1020)                                   -- Price of Killer whales

-- Rewards
Config.smallLootboxCash = math.random(10,150)                                   	-- Price of the cash reward for the "Metal Box"
