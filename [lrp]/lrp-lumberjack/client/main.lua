...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.TriggerCallback('lrp-lumberjack:server:amounts', function (lumber)
        lumbercost = lumber
    end)
end)
...
if Config.Job then
    CreateThread(function()
        for k, v in pairs(Config.TreeLocations) do
            exports["lrp-target"]:AddBoxZone("trees" .. k, v.coords, 1.5, 1.5, {
                name = "trees" .. k,
                heading = 40,
                minZ = v.coords["z"] - 2,
                maxZ = v.coords["z"] + 2,
    ...
    exports['lrp-target']:AddBoxZone("lumberjackdepo", LumberDepo.targetZone, 4, 4, {
        name = "Lumberjackdepo",
    ...
    exports['lrp-target']:AddBoxZone("LumberProcessor", LumberProcessor.targetZone, 1, 1, {
    ...
    exports['lrp-target']:AddBoxZone("LumberSeller", LumberSeller.targetZone, 1, 1, {
        name = "LumberProcessor",
    ...
    exports['lrp-target']:AddBoxZone("lumberjackdepo", LumberDepo.targetZone, 3, 3, {
        name = "Lumberjackdepo",
        heading = LumberDepo.targetHeading,
        debugPoly = false,
        minZ = LumberDepo.minZ,
...
exports['lrp-menu']:openMenu(vehicle)
end)
...
RegisterNetEvent('tr-lumberjack:processormenu', function()
    local processor = {
      ...
      },
      {
        ...
        txt = Config.Alerts["lumber_text"] .. "<br> Lumber Required: " .. lumbercost,
        params = {
...
exports['lrp-menu']:openMenu(processor)
end)
