	...
	for k, v in pairs(Config.Locations) do
		if k == "vendingmachine" and Config.VendOverride then
			...
			for l, b in pairs(v["coords"]) do
				...
				Targets["Shop - ['"..k.."("..l..")']"] =
					exports['lrp-target']:AddCircleZone("Shop - ['"..k.."("..l..")']", vector3(b.x, b.y, b.z), 2.0, { name="Shop - ['"..k.."("..l..")']", debugPoly=Config.Debug, useZ=true, },
...
RegisterNetEvent('jim-shops:ShopMenu', function(data, custom)
	...
	exports['lrp-menu']:openMenu(ShopMenu)
end)
...
RegisterNetEvent('jim-shops:CloseMenu', function() exports['lrp-menu']:closeMenu() end)
...
RegisterNetEvent('jim-shops:Charge', function(data)
	...
	local dialog = exports['lrp-input']:ShowInput({ header = header, submitText = "Pay", inputs = newinputs })
	if dialog then
