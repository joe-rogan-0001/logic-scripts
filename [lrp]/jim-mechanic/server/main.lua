...
RegisterNetEvent('QBCore:Server:UpdateObject', function() if source ~= '' then return false end QBCore = exports['lrp-core']:GetCoreObject() end)
...
RegisterNetEvent('jim-mechanic:server:registerstash', function(stashname, coords)
	exports.ox_inventory:RegisterStash(stashname.."Safe", stashname.."Safe", 50, 4000000, nil, {['mechanic'] = 0}, coords)
end)