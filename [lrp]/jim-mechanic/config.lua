...
-- NOS STUFF
	...
	NosTopSpeed = 30.0, -- Enabling this adds a multiplier to the top speed of the vehicle
...
--DuctTape Controllers
	...
	JobRoles = { "mechanic","hayes","wotc", }, -- These are the job roles who can use items if RequiresJob is enabled.
