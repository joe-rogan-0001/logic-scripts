...
CreateThread(function()
	for k, v in pairs(Config.PoliceLocations) do
		...
		exports['lrp-target']:AddBoxZone("bench"..k, v.coords, 1.2, 4.2, { name="bench"..k, heading = v.heading, debugPoly=Config.Debug, minZ = v.coords.z-1, maxZ = v.coords.z+1.4, },
...
RegisterNetEvent('jim-mechanic:client:Police:Menu', function()
	...
	if IsPedInAnyVehicle(PlayerPedId(), false) then
		...
		exports['lrp-menu']:openMenu(PoliceMenu)
	end
end)
...
RegisterNetEvent('jim-mechanic:client:Police:Extra', function()
	...
	if hadMod then exports['lrp-menu']:openMenu(ExtraMenu) elseif not hadMod then triggerNotify(nil, Loc[Config.Lan]["common"].noOptions, "error") TriggerEvent('jim-mechanic:client:Police:Menu') return end
end)
...
RegisterNetEvent('jim-mechanic:client:Police:Livery', function()
	...
	if DoesEntityExist(vehicle) then
		...
		exports['lrp-menu']:openMenu(LiveryMenu)
	end
end)
...
RegisterNetEvent('jim-mechanic:client:Police:Plates', function()
	...
	if IsPedInAnyVehicle(PlayerPedId(), false) then	vehicle = GetVehiclePedIsIn(PlayerPedId(), false) pushVehicle(vehicle)
		if DoesEntityExist(vehicle) then
			...
			exports['lrp-menu']:openMenu(PlateMenu)
		end
	end
end)
...
RegisterNetEvent('jim-mechanic:client:Police:Spoiler', function()
	...
	if DoesEntityExist(vehicle) then
		...
		exports['lrp-menu']:openMenu(spoilerMenu)
	end
end)
...
RegisterNetEvent('jim-mechanic:client:Police:Paint', function()
	...
	exports['lrp-menu']:openMenu(PaintMenu)
end)
...
AddEventHandler('onResourceStop', function(r)
	if r == GetCurrentResourceName() then
		for k, v in pairs(Config.PoliceLocations) do exports['lrp-target']:RemoveZone("bench"..k) end
