...
CreateThread(function()
		...
		if Config.Crafting then
			if v.crafting then
				for l, b in pairs(v.crafting) do
					...
					exports['lrp-target']:AddBoxZone("MechCraft: "..k..l, b.coords.xyz, b.w, b.d, { name="MechCraft: "..k..l, heading = b.coords.w, debugPoly=Config.Debug, minZ=b.coords.z-1.0, maxZ=b.coords.z+1.0 },
		...
		if Config.Stores then
			if v.store then
				for l, b in pairs(v.store) do
					...
					exports['lrp-target']:AddBoxZone("MechStore: "..k..l, b.coords.xyz, b.w, b.d, { name="MechStore: "..k..l, heading = b.coords.w, debugPoly=Config.Debug, minZ=b.coords.z-1.0, maxZ=b.coords.z+1.0 },
	...
	--Make Cash Register Locations
		if v.payments then
			...
			exports['lrp-target']:AddBoxZone("MechReceipt: "..k, v.coords.xyz, (v.w or 0.47), (v.d or 0.34), { name="MechReceipt: "..k, heading = v.coords.w, debugPoly=Config.Debug, minZ=v.coords.z-0.1, maxZ=v.coords.z+0.4 },
			...
			if Config.RequiresJob then
				if v.stash then
					for l, b in pairs(v.stash) do
						TriggerServerEvent('jim-mechanic:server:registerstash', v.job, b.coords.xyz, v.job)
						Targets["MechSafe: "..k..l] =
						exports['lrp-target']:AddBoxZone("MechSafe: "..k..l, b.coords.xyz, b.w, b.d, { name="MechSafe: "..k..l, heading = b.coords.w, debugPoly=Config.Debug, minZ=b.coords.z-1.0, maxZ=b.coords.z+1.0 },
		...
		if v.clockin then
			for l, b in pairs(v.clockin) do
				if type(b) ~= "boolean" then
					...
					exports['lrp-target']:AddBoxZone("MechClock: "..k..l, b.coords.xyz, (b.w or 0.45), (b.d or 0.4), { name="MechClock: "..k..l, heading = b.coords.w, debugPoly=Config.Debug, minZ=b.coords.z-0.1, maxZ=b.coords.z+0.4 },
						{ options = {
	...
	--Manual Repair Bench
		if v.manualRepair then
			for l, b in pairs(v.manualRepair) do
				...
				exports['lrp-target']:AddBoxZone("RepairBench: "..k..l, b.coords.xyz, (b.w or 1.2), (b.w or 4.2), { name="RepairBench: "..k..l, heading = b.coords.w, debugPoly=Config.Debug, minZ = b.coords.z-1, maxZ = b.coords.z+1.4, },
	...
	--Garage Locations
		if v.garage then
			...
			exports['lrp-target']:AddBoxZone("MechGarage: "..k, vec3(out.x, out.y, out.z-1.03), 0.8, 0.5, { name="MechGarage: "..k, heading = out[4]+180.0, debugPoly=Config.Debug, minZ=(out.z-1.03)-0.1, maxZ=out.z-1.03+1.3 },
	...
	--NosRefill Locations
		if v.nosrefill then
			for l, b in pairs(v.nosrefill) do
				...
				Targets["MechNos: "..k..l] =
				exports['lrp-target']:AddBoxZone("MechNos: "..k..l, vec3(b.coords.x, b.coords.y, b.coords.z), 0.7, 0.7, { name="MechNos: "..k..l, heading = b.coords[4], debugPoly=Config.Debug, minZ=b.coords.z-1.05, maxZ=b.coords.z+0.25 },
...
------ Repair Stash Stuff -----
RegisterNetEvent('jim-mechanic:client:Safe', function() 
	local data = QBCore.Functions.GetPlayerData()
    exports.ox_inventory:openInventory('stash', data.job.name.."Safe")
end)
...
--[[	{	job = "mechanic",
	...
	{   job = "wotc",
		...
		manualRepair = { { coords = vec4(-1421.71, -456.21, 35.91, 33.32), prop = false, } },
		garage = { spawn = vector4(774.58, -1320.54, 26.23, 181.42),
					out = vector4(779.14, -1319.61, 26.23, 90),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true, },
		payments = { coords = vector4(779.87, -1302.59, 26.33, 272.32),
			--img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/0/0c/HayesAutoBodyShop-GTAV-Logo.png width=150px></p>",
			prop = true, },
		blip = vec(768.1, -1305.4, 25.72),
		bliplabel = "Wide Open Throttle Customs",
		blipcolor = 44,
		discordlink = "",
		discordcolour = 39135,
		discordimg = "https://static.wikia.nocookie.net/gtawiki/images/0/0c/HayesAutoBodyShop-GTAV-Logo.png",
