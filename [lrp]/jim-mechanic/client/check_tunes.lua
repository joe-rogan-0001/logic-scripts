...
RegisterNetEvent('jim-mechanic:client:Menu', function()
	...
	exports['lrp-menu']:openMenu(CheckMenu)
end)
...
RegisterNetEvent('jim-mechanic:client:Menu:List', function()
	...
	if mods then exports['lrp-menu']:openMenu(CheckMenu) else triggerNotify(nil, Loc[Config.Lan]["common"].noOptions, "error") return end
end)
