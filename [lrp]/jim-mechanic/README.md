...
- This displays information about the vehicle's currently installed peformance modifications
	- It will attempt to grab information from lrp-core's `vehicles.lua` to display vehicle names and the value, it does this by searching for a matching "model hash".
...
- They are activated by targetting with `lrp-targett` while in a car
...
- This is activated by using third eye/lrp-targett
...
### Config.img
- Use this if if you are using an older/edited version of lrp-menu
- This is for adding images of inventory items to lrp-menu and lrp-input.
...
### Config.JimMenu
- Set this to true if you have an updated lrp-menu with inventory icon/fontawesome support
...
- Add these lines to your lrp-core > shared lua under the Items section
...
- This script requires `lrp-targett` for opening stores, crafting tables, cash registers, going on duty, nos refill
...
- To add the ability to save RGB paints, their colour finishes and drift/bulletproof tires you need to change two functions in your lrp-core/client/functions.lua
