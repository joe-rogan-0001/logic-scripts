...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    TriggerServerEvent('qb-bikedealership:server:addPlayer', citizenid, gameTime)
    TriggerServerEvent('qb-bikedealership:server:checkFinance')
...
RegisterNetEvent('QBCore:Client:OnPlayerUnload', function()
    local citizenid = PlayerData.citizenid
    TriggerServerEvent('qb-bikedealership:server:removePlayer', citizenid)
    PlayerData = {}
end)
...
local vehHeaderMenu = {
    {
        ...
        params = {
            event = 'qb-bikedealership:client:showVehOptions'
        }
    }
}
...
local financeMenu = {
    {
        ...
        params = {
            event = 'qb-bikedealership:client:getVehicles'
        }
    }
}
...
local returnTestDrive = {
    {
        ...
        params = {
            event = 'qb-bikedealership:client:TestDriveReturn'
        }
    }
}
...
local function createTestDriveReturn()
    ...
    testDriveZone:onPlayerInOut(function(isPointInside)
        if isPointInside and IsPedInAnyVehicle(PlayerPedId()) then
            ...
            exports['lrp-menu']:openMenu(returnTestDrive)
        else
...
local function createVehZones(shopName, entity)
    if not Config.UsingTarget then
        ...
        combo:onPlayerInOut(function(isPointInside)
            if isPointInside then
                if PlayerData.job.name == Config.Shops[insideShop]['Job'] or Config.Shops[insideShop]['Job'] == 'none' then
                    exports['lrp-menu']:showHeader(vehHeaderMenu)
                end
            else
                exports['lrp-menu']:closeMenu()
            end
        ...
        exports['lrp-target']:AddTargetEntity(entity, {
            options = {
                {
                    type = "client",
                    event = "qb-bikedealership:client:showVehOptions",
                ...
                while insideShop do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'qb-bikedealership:client:TestDrive',
                            }
                        },
                        {
                            ...
                            params = {
                                isServer = true,
                                event = 'qb-bikedealership:server:buyShowroomVehicle',
                                args = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'qb-bikedealership:client:openFinance',
                                args = {
                                    price = getVehPrice(),
                                    buyVehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'qb-bikedealership:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
                ...
                while insideShop and PlayerData.job and PlayerData.job.name == Config.Shops[name]['Job'] do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'qb-bikedealership:client:openIdMenu',
                                args = {
                        ...
                        },
                        {
                            ...
                            icon = "fa-solid fa-coins",
                            params = {
                                event = 'qb-bikedealership:client:openCustomFinance',
                                args = {
                                    price = getVehPrice(),
                                    vehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
...
function Init()
    ...
    CreateThread(function()
        ...
        financeZone:onPlayerInOut(function(isPointInside)
            if isPointInside then
                exports['lrp-menu']:showHeader(financeMenu)
            else
                exports['lrp-menu']:closeMenu()
            end
        end)
...
-- Events
RegisterNetEvent('qb-bikedealership:client:homeMenu', function()
    exports['lrp-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('qb-bikedealership:client:showVehOptions', function()
    exports['lrp-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('qb-bikedealership:client:TestDrive', function()
...
RegisterNetEvent('qb-bikedealership:client:customTestDrive', function(data)
...
RegisterNetEvent('qb-bikedealership:client:TestDriveReturn', function()
...
RegisterNetEvent('qb-bikedealership:client:vehCategories', function()
    local categoryMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = "fa-solid fa-angle-left",
            params = {
                event = 'qb-bikedealership:client:homeMenu'
            }
        }
    }
    for k, v in pairs(Config.Shops[insideShop]['Categories']) do
        categoryMenu[#categoryMenu + 1] = {
            ...
            params = {
                event = 'qb-bikedealership:client:openVehCats',
                args = {
                    catName = k
                }
            }
...
RegisterNetEvent('qb-bikedealership:client:openVehCats', function(data)
    local vehMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = "fa-solid fa-angle-left",
    ...
    for k, v in pairs(QBCore.Shared.Vehicles) do
        if QBCore.Shared.Vehicles[k]["category"] == data.catName and QBCore.Shared.Vehicles[k]["shop"] == insideShop then
            vehMenu[#vehMenu + 1] = {
                ...
                params = {
                    isServer = true,
                    event = 'qb-bikedealership:server:swapVehicle',
                    args = {
                        toVehicle = v.model,
    ...
    exports['lrp-menu']:openMenu(vehMenu)
end)

RegisterNetEvent('qb-bikedealership:client:openFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-bikedealership:server:financeVehicle', dialog.downPayment, dialog.paymentAmount, data.buyVehicle)
    end
end)

RegisterNetEvent('qb-bikedealership:client:openCustomFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-bikedealership:server:sellfinanceVehicle', dialog.downPayment, dialog.paymentAmount, data.vehicle, dialog.playerid)
    end
end)

RegisterNetEvent('qb-bikedealership:client:swapVehicle', function(data)
...
RegisterNetEvent('qb-bikedealership:client:buyShowroomVehicle', function(vehicle, plate)
    QBCore.Functions.SpawnVehicle(vehicle, function(veh)
        TaskWarpPedIntoVehicle(PlayerPedId(), veh, -1)
        exports['ps-fuel']:SetFuel(veh, 100)
...
RegisterNetEvent('qb-bikedealership:client:getVehicles', function()
    QBCore.Functions.TriggerCallback('qb-bikedealership:server:getVehicles', function(vehicles)
        local ownedVehicles = {}
        for _, v in pairs(vehicles) do
            if v.balance ~= 0 then
                ...
                ownedVehicles[#ownedVehicles + 1] = {
                    ...
                    icon = "fa-solid fa-car-side",
                    params = {
                        event = 'qb-bikedealership:client:getVehicleFinance',
                        args = {
                            vehiclePlate = plate,
                            balance = v.balance,
...
RegisterNetEvent('qb-bikedealership:client:getVehicleFinance', function(data)
    local vehFinance = {
        {
            header = Lang:t('menus.goback_header'),
            params = {
        ...
        },
        {
            ...
            icon = "fa-solid fa-hand-holding-dollar",
            params = {
                event = 'qb-bikedealership:client:financePayment',
                args = {
                    vehData = data,
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'qb-bikedealership:server:financePaymentFull',
                args = {
    ...
    exports['lrp-menu']:openMenu(vehFinance)
end)

RegisterNetEvent('qb-bikedealership:client:financePayment', function(data)
    local dialog = exports['lrp-input']:ShowInput({
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-bikedealership:server:financePayment', dialog.paymentAmount, data.vehData)
    end
end)

RegisterNetEvent('qb-bikedealership:client:openIdMenu', function(data)
    local dialog = exports['lrp-input']:ShowInput({
    ...
    if dialog then
        ...
        if data.type == 'testDrive' then
            TriggerServerEvent('qb-bikedealership:server:customTestDrive', data.vehicle, dialog.playerid)
        elseif data.type == 'sellVehicle' then
            TriggerServerEvent('qb-bikedealership:server:sellShowroomVehicle', data.vehicle, dialog.playerid)
        end
    end
end)

RegisterNetEvent('qb-bikedealership:client:winCar', function (carname)
	local vehicle = QBCore.Functions.GetClosestVehicle(vector3(935.01, 42.80, 72.43))
	local showCar = carname
	TriggerServerEvent('qb-bikedealership:server:luckywheelWin', vehicle, showCar)
end)

RegisterNetEvent('qb-bikedealership:client:winLuckyWheelVehicle', function(vehicle, plate)
