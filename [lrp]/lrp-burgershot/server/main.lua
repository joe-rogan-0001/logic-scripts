...
RegisterServerEvent("lrp-burgershot:bill:player")
AddEventHandler("lrp-burgershot:bill:player", function(playerId, amount)
...
QBCore.Functions.CreateCallback('lrp-burgershot:server:get:ingredientBurger', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('lrp-burgershot:server:get:ingredientTorpedo', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('lrp-burgershot:server:get:ingredientMeatfree', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local bun = Ply.Functions.GetItemByName("burger-bun")
...
QBCore.Functions.CreateCallback('lrp-burgershot:server:get:ingredientMurderMeal', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("burger-murdermeal", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("lrp-burgershot:MurderMeal", source, item.name)
end)
