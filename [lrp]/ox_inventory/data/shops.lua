...
--[[	Liquor = {
	...
	YouTool = {
		...
		blip = {
			...
			{ name = 'advancedrepairkit', price = 750 },
	...
	Ammunation = {
		...
		blip = {
			...
			{ name = 'WEAPON_GLOCK', price = 7500, metadata = { registered = true }, license = 'weapon' },
	...
	BlackMarketArms = {
		name = '',
		inventory = {
			{ name = 'WEAPON_MICROSMG2', price = 25000, metadata = { registered = false	}, currency = 'black_money' },
			{ name = 'WEAPON_PISTOL50', price = 15000, metadata = { registered = false }, currency = 'black_money' },
