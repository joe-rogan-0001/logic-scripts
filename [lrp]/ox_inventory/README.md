...
Experimental support for [lrp-coreee](https://github.com/qbcore-frameworlrp-corerere) has been added, but requires a recent installation. Do not expect 100% compatibility or support.
