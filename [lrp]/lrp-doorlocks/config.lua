...
-- vespucciv2clubbygate 
Config.DoorList['vespucciv2clubbygate'] = {
    locked = true,
    objCoords = vec3(-1166.221191, -1186.105591, 4.655549),
    maxDistance = 6.0,
    objHeading = 190.41551208496,
    garage = true,
    fixText = false,
    audioRemote = false,
    lockpick = false,
...
-- vespucciv2entrancedoor 
Config.DoorList['vespucciv2entrancedoor'] = {
    locked = true,
    objCoords = vec3(-1175.177979, -1192.976318, 6.073421),
    maxDistance = 2.0,
    objHeading = 190.00001525879,
    garage = false,
    fixText = false,
    audioRemote = false,
    lockpick = false,
...
-- vv2doubleentrancedoor1 
Config.DoorList['vv2doubleentrancedoor1'] = {
    locked = true,
    lockpick = false,
    audioRemote = false,
    maxDistance = 2.5,
    slides = false,
    doors = {
        {objHash = -1355256628, objHeading = 279.99996948242, objCoords = vec3(-1178.757446, -1182.726074, 5.897286)},
        {objHash = -1355256628, objHeading = 99.999977111816, objCoords = vec3(-1178.306763, -1185.281372, 5.897286)}
    },
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
-- vv2garageentrancedoor1 
Config.DoorList['vv2garageentrancedoor1'] = {
    locked = true,
    objCoords = vec3(-1173.646118, -1173.114624, 6.526886),
    maxDistance = 6.0,
    objHeading = 15.000122070313,
    garage = true,
    fixText = false,
    audioRemote = false,
    lockpick = false,
...
-- vv2garageindoordouble1 
Config.DoorList['vv2garageindoordouble1'] = {
    locked = true,
    lockpick = false,
    audioRemote = false,
    maxDistance = 2.5,
    slides = false,
    doors = {
        {objHash = -1355256628, objHeading = 9.9999990463257, objCoords = vec3(-1185.699951, -1175.406128, 5.895852)},
        {objHash = -1355256628, objHeading = 190.00001525879, objCoords = vec3(-1183.151245, -1174.952759, 5.895852)}
    },
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
-- vv2garageoffice 
Config.DoorList['vv2garageoffice'] = {
    locked = true,
    objCoords = vec3(-1194.548340, -1165.926880, 9.456146),
    maxDistance = 2.0,
    objHeading = 190.0,
    garage = false,
    fixText = false,
...
-- vv2kitchendouble 
Config.DoorList['vv2kitchendouble'] = {
    locked = true,
    lockpick = false,
    audioRemote = false,
    maxDistance = 2.5,
    slides = false,
    doors = {
        {objHash = -1355256628, objHeading = 9.9999990463257, objCoords = vec3(-1190.113159, -1159.287842, 5.748736)},
        {objHash = -1355256628, objHeading = 190.0, objCoords = vec3(-1187.564575, -1158.822510, 5.748736)}
    },
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
-- vv2roofdoor 
Config.DoorList['vv2roofdoor'] = {
    locked = true,
    objCoords = vec3(-1187.102173, -1139.443970, 14.564635),
    maxDistance = 2.0,
    objHeading = 291.16897583008,
    garage = false,
    fixText = false,
    audioRemote = false,
    lockpick = false,
...
-- vv2changerooms 
Config.DoorList['vv2changerooms'] = {
    locked = true,
    objCoords = vec3(-1190.679443, -1150.938599, 5.704319),
    maxDistance = 2.0,
    objHeading = 190.00001525879,
    garage = false,
    fixText = false,
...
-- vv2secretslidingdoor 
Config.DoorList['vv2secretslidingdoor'] = {
    locked = true,
    objCoords = vec3(-1196.204224, -1152.582031, 4.653471),
    maxDistance = 2.0,
    objHeading = 9.9999990463257,
    garage = true,
    fixText = false,
    audioRemote = false,
    lockpick = false,
...
-- vv2churchdouble 
Config.DoorList['vv2churchdouble'] = {
    locked = true,
    lockpick = false,
    audioRemote = false,
    maxDistance = 2.5,
    slides = false,
    doors = {
        {objHash = -1210156958, objHeading = 279.99996948242, objCoords = vec3(-1188.289185, -1185.265503, 12.033862)},
        {objHash = -1210156958, objHeading = 99.999977111816, objCoords = vec3(-1187.834717, -1187.812988, 12.033862)}
    },
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
Config.DoorList['vv2prezoffice'] = {
    ...
    slides = false,
    doors = {
        {objHash = -1355256628, objHeading = 280.0, objCoords = vec3(-1189.387085, -1179.222656, 12.035128)},
        {objHash = -1355256628, objHeading = 99.999977111816, objCoords = vec3(-1188.926025, -1181.778931, 12.030533)}
    },
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
-- vv2downstairs1 
Config.DoorList['vv2downstairs1'] = {
    locked = true,
    objCoords = vec3(-1188.861328, -1154.671265, 0.889005),
    maxDistance = 2.0,
...
-- vv2downstairs2 
Config.DoorList['vv2downstairs2'] = {
    locked = true,
    objCoords = vec3(-1187.942993, -1159.963013, 0.888894),
    maxDistance = 2.0,
    objHeading = 280.00003051758,
    garage = false,
    fixText = false,
...
-- vv2downstairs3 
Config.DoorList['vv2downstairs3'] = {
    locked = true,
    objCoords = vec3(-1192.076172, -1161.520630, 0.897323),
    maxDistance = 1.5,
    objHeading = 190.00001525879,
    garage = false,
    fixText = false,
...
-- vv2downescape1 
Config.DoorList['vv2downescape1'] = {
    locked = true,
    objCoords = vec3(-1180.557983, -1160.406494, 0.899244),
    maxDistance = 2.0,
    objHeading = 99.999977111816,
    garage = false,
    fixText = false,
    audioRemote = false,
    lockpick = false,
...
-- vv2downescapemain 
Config.DoorList['vv2downescapemain'] = {
    garage = false,
    slides = false,
    fixText = false,
    maxDistance = 2.0,
    ...
    lockpick = false,
    locked = true,
    objCoords = vec3(-1153.743164, -1157.008667, 2.903632),
    objHash = -172886857,
    objHeading = 17.295951843262,
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
    --audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
Config.DoorList['vv2cell'] = {
    ...
    lockpick = false,
    locked = true,
    objCoords = vec3(-1189.803711, -1164.634888, 0.877034),
    objHash = 631614199,
    objHeading = 280.0,
    authorizedGangs = { ['savagemc']=0 },
    --oldMethod = true,
...
-- gambinofront created by Griddy
Config.DoorList['gambinofront'] = {
    lockpick = false,
    slides = false,
    locked = true,
    audioRemote = false,
    doors = {
        {objHash = 951790256, objHeading = 210.00001525879, objCoords = vec3(411.544586, -1489.343506, 30.304014)},
        {objHash = 951790256, objHeading = 30.000001907349, objCoords = vec3(413.429077, -1488.255615, 30.304014)}
    },
    maxDistance = 2.5,
...
-- gambinofront2 created by Griddy
Config.DoorList['gambinofront2'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(415.956940, -1484.879272, 30.297621),
    maxDistance = 2.0,
    locked = true,
...
-- gambinofront3 created by Griddy
Config.DoorList['gambinofront3'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(407.412109, -1489.812622, 30.297621),
    maxDistance = 2.0,
    locked = true,
    objHeading = 119.99998474121,
    --oldMethod = true,
...
-- gambinofront4 created by Griddy
Config.DoorList['gambinofront4'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(408.765167, -1500.079712, 30.303263),
    maxDistance = 2.0,
    locked = true,
    objHeading = 300.0,
    --oldMethod = true,
...
-- gambinofrontkitchen created by Griddy
Config.DoorList['gambinofrontkitchen'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(411.957397, -1502.112183, 30.304224),
    maxDistance = 2.0,
    locked = true,
...
-- gambinofront66 created by Griddy
Config.DoorList['gambinofront66'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(420.512085, -1481.447632, 30.301252),
    maxDistance = 2.0,
    locked = true,
...
-- gambinofro424 created by Griddy
Config.DoorList['gambinofro424'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(423.686584, -1501.412476, 30.301899),
    maxDistance = 2.0,
    locked = true,
    objHeading = 210.0,
    --oldMethod = true,
...
-- gambinofro4242 created by Griddy
Config.DoorList['gambinofro4242'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(425.438354, -1505.386230, 29.465919),
    maxDistance = 2.0,
    locked = true,
    objHeading = 119.99998474121,
    --oldMethod = true,
...
-- gambinofro422 created by Griddy
Config.DoorList['gambinofro422'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 933053701,
    objCoords = vec3(423.596313, -1505.472900, 29.465919),
    maxDistance = 2.0,
    locked = true,
...
-- gambinofro4222 created by Griddy
Config.DoorList['gambinofro4222'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 1388116908,
    objCoords = vec3(428.185944, -1514.622314, 29.446213),
    maxDistance = 2.0,
    locked = true,
...
-- gambinofro42224 created by Griddy
Config.DoorList['gambinofro42224'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 1173348778,
    objCoords = vec3(425.194000, -1513.374878, 29.469046),
    maxDistance = 2.0,
    locked = true,
    objHeading = 120.0,
    --oldMethod = true,
...
-- gambinofro422244 created by Griddy
Config.DoorList['gambinofro422244'] = {
    slides = false,
    garage = false,
    authorizedGangs = { ['gambino']=0 },
    audioRemote = false,
    ...
    fixText = false,
    objHash = 964838196,
    objCoords = vec3(418.017395, -1490.622070, 33.955021),
    maxDistance = 2.0,
    locked = true,
...
-- gambinofro4222444 created by Griddy
Config.DoorList['gambinofro4222444'] = {
    lockpick = false,
    slides = false,
    locked = true,
    audioRemote = false,
    doors = {
        {objHash = 964838196, objHeading = 120.00000762939, objCoords = vec3(415.939819, -1496.192993, 33.957245)},
        {objHash = 964838196, objHeading = 300.0, objCoords = vec3(417.239288, -1498.443726, 33.957245)}
    },
    maxDistance = 2.5,
    authorizedGangs = { ['gambino']=0 },
    --oldMethod = true,
...
-- gambinofro42224444 created by Griddy
Config.DoorList['gambinofro42224444'] = {
    lockpick = false,
    slides = false,
    locked = true,
    audioRemote = false,
    doors = {
        {objHash = 1770281453, objHeading = 300.0, objCoords = vec3(423.999664, -1506.966309, 33.898457)},
        {objHash = 1770281453, objHeading = 120.00000762939, objCoords = vec3(422.683716, -1504.725098, 33.899532)}
    },
    maxDistance = 2.5,
    authorizedGangs = { ['gambino']=0 },
    --oldMethod = true,
