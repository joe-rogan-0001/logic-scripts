...
-- mirrorpark gambino created by Let that sink in
Config.DoorList['mirrorpark gambino'] = {
    audioRemote = false,
    slides = false,
    garage = false,
    objHash = 302311584,
    fixText = false,
    lockpick = false,
    objHeading = 75.000030517578,
    maxDistance = 2.0,
    authorizedGangs = { ['gambino']=0 },
    objCoords = vec3(1218.437012, -417.220276, 67.881058),
    locked = true,
    --oldMethod = true,
    --audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
    --audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
