...
local ThermiteSettings = {
    ['fleeca'] = {
        correctBlocks = 15, -- correctBlocks = Number of correct blocks the player needs to click
        incorrectBlocks = 4, -- incorrectBlocks = number of incorrect blocks after which the game will fail
        timetoShow = 3.5, -- timetoShow = time in secs for which the right blocks will be shown
        timetoLose = 12 -- timetoLose = maximum time after timetoshow expires for player to select the right blocks
    },
    ['paleto'] = {
        correctBlocks = 18, -- You want to set this way higher!
        incorrectBlocks = 3,
        timetoShow = 3,
        timetoLose = 8
    },
    ['pacific'] = {
        correctBlocks = 22, -- You want to set this way higher!
        incorrectBlocks = 2,
        timetoShow = 2,
        timetoLose = 7
    },
...
CreateThread(function()
    ...
    if Config.Gabz.fleeca == false then
        exports['lrp-target']:AddBoxZone("BankPanelPinkCage", vector3(311.6, -284.60, 53.78), 0.2, 0.46, {
        ...
        exports['lrp-target']:AddBoxZone("BankPanelLegion", vector3(147.19, -1046.2, 28.91), 0.3, 0.44, {
        ...
        exports['lrp-target']:AddBoxZone("BankPanelHawick", vector3(-353.47, -55.48, 48.71), 0.2, 0.46, {
        ...
        exports['lrp-target']:AddBoxZone("BankPanelDelPerro", vector3(-1210.38, -336.40, 37.68), 0.24, 0.46, {
        ...
        exports['lrp-target']:AddBoxZone("BankPanelGreatOcean", vector3(-2956.48, 482.1, 15.65), 0.24, 0.46, {
        ...
        exports['lrp-target']:AddBoxZone("BankPanelSandy", vector3(1175.66, 2712.90, 37.99), 0.24, 0.46, {
            name = "BankPanelSandy",
            heading = 89,
            debugPoly = false,
            minZ = 38.00,
    ...
    elseif Config.Gabz.fleeca == true then
        exports['lrp-target']:AddBoxZone("BankPanelPinkCage", vector3(311.06, -284.67, 54.16), 0.4, 0.6, {
            name = "BankPanelPinkCage",
            heading = 340,
            debugPoly = false,
            minZ = 53.96,
        ...
        exports['lrp-target']:AddBoxZone("BankPanelLegion", vector3(146.69, -1046.44, 29.37), 0.4, 0.6, {
            name = "BankPanelLegion",
            heading = 340,
            debugPoly = false,
            minZ = 29.27,
        ...
        exports['lrp-target']:AddBoxZone("BankPanelHawick", vector3(-354.02, -55.61, 49.04), 0.4, 0.6, {
            name = "BankPanelHawick",
            heading = 338,
            debugPoly = false,
            minZ = 48.84,
        ...
        exports['lrp-target']:AddBoxZone("BankPanelDelPerro", vector3(-1210.75, -336.77, 37.78), 0.4, 0.6, {
            name = "BankPanelDelPerro",
            heading = 26,
            debugPoly = false,
            minZ = 37.58,
        ...
        exports['lrp-target']:AddBoxZone("BankPanelGreatOcean", vector3(-2956.33, 481.61, 15.7), 0.6, 0.4, {
            name = "BankPanelGreatOcean",
            heading = 358,
            debugPoly = false,
            minZ = 15.50,
        ...
        exports['lrp-target']:AddBoxZone("BankPanelSandy", vector3(1176.04, 2713.15, 38.09), 0.4, 0.6, {
            name = "BankPanelSandy",
            heading = 359,
            debugPoly = false,
            minZ = 37.89,
    ...
    -- Maze Bank
    exports['lrp-target']:AddBoxZone("BankPanelMaze", vector3(-1303.85, -815.63, 17.15), 0.24, 0.46, {
        name = "BankPanelMaze",
        heading = 308.00,
        debugPoly = false,
        minZ = 17.35,
    ...
    -- Paleto
    exports['lrp-target']:AddBoxZone("BankPanelPaleto", vector3(-109.39, 6483.2, 31.48), 0.24, 0.46, {
    ...
    exports['lrp-target']:AddBoxZone("PaletoCard", vector3(-105.8362, 6472.1029, 31.626703), 0.3, 0.4, {
        name = "PaletoCard",
        heading = 73,
        debugPoly = false,
        minZ = 31.79,
    ...
    -- Pacific
    exports['lrp-target']:AddBoxZone("BankPanelPacific", vector3(252.88, 228.55, 101.68), 0.3, 0.4, {
    ...
    exports['lrp-target']:AddBoxZone("PacificCard", vector3(262.31, 223.01, 106.28), 0.2, 0.4, {
        name = "PacificCard",
        heading = 250,
        debugPoly = false,
        minZ = 106.29,
    ...
    -- Vault
    exports['lrp-target']:AddBoxZone("VaultGoldLaptop", vector3(257.60, 228.20, 101.68), 0.2, 0.25, {
    ...
    exports['lrp-target']:AddBoxZone("VaultGreyUsb", vector3(252.14, 235.93, 102.49), 0.3, 0.6, {
        name = "VaultGreyUsb",
        heading = 253.00,
        debugPoly = false,
        minZ = 101.40,
    ...
    exports['lrp-target']:AddBoxZone("VaultEnterCode", vector3(261.61, 258.43, 101.69), 0.3, 0.3, {
        name = "VaultEnterCode",
        heading = 340.00,
        debugPoly = false,
        minZ = 102.00,
    ...
    for k, v in pairs(Config.Banks) do
        for i=1, #v.lockers do
            exports['lrp-target']:AddBoxZone("Locker"..k..i, v.lockers[i].coords.xyz, 0.5, 2.0, {
                name = "Locker"..k..i,
    ...
    for k, v in pairs(Config.Banks) do
        for i=1, #v.trolly do
            exports['lrp-target']:AddBoxZone("Trolly"..k..i, v.trolly[i].coords.xyz, 0.5, 1.0, {
                name = "Trolly"..k..i,
    ...
    for k, v in pairs(Config.Banks['Vault'].stacks) do
        exports['lrp-target']:AddBoxZone("VaultStack"..k, v.coords.xyz, 0.5, 0.7, {
            name = "VaultStack"..k,
            heading = v.coords.w,
            debugPoly = false,
            minZ = 101.550,
