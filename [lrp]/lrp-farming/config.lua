...
Config.SellLocation =  {x = -578.08, y = -1013.01, z = 22.33}
...
Config.ItemList = {
    ["orange"] = math.random(30, 35),
    ["milk"] = math.random(30, 35),
	["corn_kernel"] = math.random(25, 40),
    ["corn_packet"] = math.random(50, 70),
    ["milk_pack"] = math.random(350, 450),
	["fruit_pack"] = math.random(250, 350),
}
...
Config.Blips = {
	...
	{title="Farm Seller", colour=16, id=272, x = -578.08, y = -1013.01, z = 22.33},
}
