...
local function CreateApartmentFurnished(spawn)
	local objects = {}
    local POIOffsets = {}
    POIOffsets.exit = json.decode('{"x":3.95,"y":3.52,"z":1.02,"h":0.0}')
    POIOffsets.stash = json.decode('{"x":-0.17,"y":2.08,"z":0.2,"h":0.0}')
	POIOffsets.clothes = json.decode('{"x":-0.27,"y":-2.6,"z":1.02,"h":0.0}')
	POIOffsets.logout = json.decode('{"x":-3.38,"y":-0.79,"z":1.02,"h":0.0}')
	DoScreenFadeOut(500)
