window.addEventListener('message', function(event) {
  ...
  switch (event.data.nui) {
      ...
      case 'lawyerpass':
          ...
          break;
      case 'fishinglicense':
          $('#seximg').attr('src', 'assets/img/fishing.png');
          $("#name").html(event.data.information.name);
          $("#lastname").html(event.data.information.lastname);
          $("#dob").html(event.data.information.dob);
          $("#sex").html('');
          $("#nationality").html('');
          $("#type").html('');
          $('#card').css('background', 'url("/ui/assets/img/fishinglicense.png") no-repeat');
          $('#card').css('background-size', '61.2vh');
          break;
      case 'huntinglicense':
          $('#seximg').attr('src', 'assets/img/hunting.png');
          $("#name").html(event.data.information.name);
          $("#lastname").html(event.data.information.lastname);
          $("#dob").html(event.data.information.dob);
          $("#sex").html('');
          $("#nationality").html('');
          $("#type").html('');
          $('#card').css('background', 'url("/ui/assets/img/huntinglicense.png") no-repeat');
          $('#card').css('background-size', '61.2vh');
          break;
      case 'pilotlicense':
          $('#seximg').attr('src', 'assets/img/pilot.png');
          $("#name").html(event.data.information.name);
          $("#lastname").html(event.data.information.lastname);
          $("#dob").html(event.data.information.dob);
          $("#sex").html('');
          $("#nationality").html('');
          $("#type").html('');
          $('#card').css('background', 'url("/ui/assets/img/pilotlicense.png") no-repeat');
          $('#card').css('background-size', '61.2vh');
          break;
      case 'boatinglicense':
          $('#seximg').attr('src', 'assets/img/boating.png');
          $("#name").html(event.data.information.name);
          $("#lastname").html(event.data.information.lastname);
          $("#dob").html(event.data.information.dob);
          $("#sex").html('');
          $("#nationality").html('');
          $("#type").html('');
          $('#card').css('background', 'url("/ui/assets/img/boatinglicense.png") no-repeat');
          $('#card').css('background-size', '61.2vh');
          break;
  }
});
