...
RegisterNetEvent('truckrobbery:AddPeds', function(veh)
    ...
    GiveWeaponToPed(ped2, GetHashKey('WEAPON_COMBATMG'), 420, 0, 1)
    GiveWeaponToPed(ped3, GetHashKey('WEAPON_COMBATMG'), 420, 0, 1)
    GiveWeaponToPed(ped4, GetHashKey('WEAPON_COMBATMG'), 420, 0, 1)

    SetPedMaxHealth(ped2, 1000)
    SetPedMaxHealth(ped3, 1000)
    SetPedMaxHealth(ped4, 1000)

    SetEntityHealth(ped2, 1000)
    SetEntityHealth(ped3, 1000)
    SetEntityHealth(ped4, 1000)
