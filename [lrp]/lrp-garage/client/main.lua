        ...
        elseif OutsideVehicles[vehicle.plate] then
            ...
            QBCore.Functions.SpawnVehicle(vehicle.vehicle, function(veh)
                QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
                    ...
                    SetEntityHeading(veh, 354.02)
                    exports['qb-notify']:Alert("Depot", "Your vehicle has been parked outside!", '5000', 'info')
...
RegisterNetEvent('qb-garages:client:TakeOutDepotVehicle', function(vehicle)
    local impound1 = vector3(-177.93, -1166.71, 23.04)
    ...
    local isclear = IsSpawnPointClear(vector3(-177.93, -1166.71, 23.04), 3.0)
            ...
            if garage <= 6 then                 
                ...
                QBCore.Functions.TriggerCallback('qb-garage:server:checkVehicleOwnergang', function(owned)                    
                    if DoesEntityExist(vehicleclose) and owned then            
                        ...
                        local totalFuel = exports['lj-fuel']:GetFuel(vehicleclose)
...
CreateThread(function()
    ...
    local Depot = AddBlipForCoord(vector3(-191.89, -1162.29, 23.67))
    ...
    options = {
        {
            ...
            canInteract = function()
                local ped = PlayerPedId()
                local pos = GetEntityCoords(ped)
                local pedpos = #(pos - vector3(-193.6, -1162.38, 22.67))
