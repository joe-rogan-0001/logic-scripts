...
Config.MaxErrors       = 6
Config.UseTarget       = true                             --CURRENTLY NOT WORKING! (recommend leaving false until future update) Gotta fix the target menu to auto change without having to restart . True will use  instead of qb-menu False will use qb-menu
Config.Ped = 's_m_y_cop_01'                                 --Will Spawn this ped for  if Config.UseTarget is true
...
Config.VehicleModels = {
  driver = 'minivan',                                         -- Car to spawn with Driver's Test
  cdl =   'man'                                          -- Truck to spawn with CDL Test
}
