...
Config.Weather = "lrp-weathersync" -- "av_weather", "cd_easytime" or "qb-weathersync" / For other weather add your export in client/framework/weather.lua
Config.Account = "bank" -- Money account used to pay everything
Config.TargetSystem = "lrp-target" -- "qtarget", "qb-target", if using ox_target leave it as qb-target.
...
Config.Society = "av_society" -- Available options: esx_society, av_society (the one from restaurants) or qb-management
...
Config.LaptopCategories = {
    ...
    {value = "house", label = "House"}, -- If you have a housing script you can promote the houses too
}