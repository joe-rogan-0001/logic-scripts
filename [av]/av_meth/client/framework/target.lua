...
for i=1, #labsTargetCoords do
    ...
    exports['lrp-target']:AddBoxZone(lab['name'], lab['center'], lab['length'], lab['width'], {
        name = lab['name'],
        heading = lab['heading'],
        debugPoly = false,
        minZ = lab['minZ'],
...
exports['lrp-target']:AddTargetModel('bkr_prop_meth_table01a', {
    options = {
        {
            type = "client",
            event = "av_meth:cook",
...
exports['lrp-target']:AddBoxZone("MethDeliveryZone", vector3(-1361.86, -758.79, 22.5), 1.45, 1.20, {
